...
- **夸张要适度，可爱第一**。用户反馈：气鼓鼓整张脸涨成红气球「很丑」、哼喷一大团白气「太夸张没必要」、整体「太神经」。表情和小特效到位就行，别把人物变形成另一个东西、别让特效盖住人。
- **意思要一眼看懂**。「服了」「不愧是你」被评「不知道何意味」：动作必须直接对应那句话在聊天里的意思。
- **只有打击类加速**。表情类（不想理你、哼、白眼）保持正常节奏，不要做得又快又抽。
...
3. 每张：
   ...
   **boomerang 只能用于可逆动作**（转身、点头、叉腰）。有方向性的动作（流泪、喷气、扔东西、踢飞、打滚）倒放一眼就穿帮，用户明确说「这种不能通过」—— 必须 `--mode cut`，接不上就换片段或重生成。
